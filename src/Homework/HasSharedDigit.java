...
/*Write a method named hasSharedDigit with two parameters of type int.
        ...
        * hasSharedDigit(15, 55); → should return true since the digit 5 appears in both numbers NOTE: The method hasSharedDigit should be defined as public static8*/
...
public class HasSharedDigit {
    ...
    public static boolean hasSharedDigit(int firstNumber, int secondNumber) {
        if ((firstNumber >= 10 && firstNumber <= 99) && (secondNumber >= 10 && secondNumber <= 99)) {
            int firstNumberLastDigit = firstNumber % 10;//--->12---->2
            int secondNumberLastDigit = secondNumber % 10;//-->23--->3
            firstNumber /= 10;//----->1
            secondNumber /= 10;//---->2
